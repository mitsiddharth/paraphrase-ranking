...
echo 'arguments = "' /u/sid/paraphrase-ranking/code/features/collectUnigrams.py $paraphrases_to_match /scratch/cluster/sid/ukwac-matched-sentences/text /scratch/cluster/sid/ukwac-matched-sentences/unigrams/unigrams_'"'
